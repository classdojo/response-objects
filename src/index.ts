...
const proto: ResponseObject<undefined> = {
  toJSON,
  toString,
  body: undefined,
  status: 0,
...
const errProto: ResponseObject<undefined> = Object.assign(
...
namespace R {
  ...
  export function PayloadTooLarge<T>(
    body?: T,
    headers?: object
  ): ErrorResponseObject<T> {
    if (responses.has(body as any))
  ...
  export function RangeNotSatisfiable<T>(
    body?: T,
    headers?: object
  ): ErrorResponseObject<T> {
    if (responses.has(body as any))
