declare function R<T>(code: number, body: T, headers?: any): R.ResponseObject<T>;
declare namespace R {
    interface BaseResponseObject<T> {
        body: T;
        status: number;
        headers?: object;
    }
    interface ResponseObject<T> extends BaseResponseObject<T> {
        statusCode: number;
        toJSON(): BaseResponseObject<T>;
        toString(): string;
    }
    interface ErrorResponseObject<T> extends ResponseObject<T>, Error {
    }
